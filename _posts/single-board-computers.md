...
date: 2023-06-26
lastmod: 2024-01-31T22:28:11.112Z
author: Mike Thomas
...
| Item                         | Revision | SoC     | RAM   | Case                              | Storage                      | OS                                                       | Hostname   | Notes                                                               |
| ---------------------------- | -------- | ------- | ----- | --------------------------------- | ---------------------------- | -------------------------------------------------------- | ---------- | ------------------------------------------------------------------- |
| Raspberry Pi 3 Model A+ V1.0 | 9020e0   | BCM2837 | 512MB | [AM8 Switchwire](printer-am8)     | 64GB MicroSD (Integral)      | Raspberry Pi OS Lite (Legacy, 32-bit) - Bullseye         | am8        | Boxed. Klipper installed via [Kiauh](https://github.com/dw-0/kiauh) |
...
| Raspberry Pi 4 Model B V1.4 | c03114   | BCM2711 | 4GB | [pi-top [4] DIY Edition](https://www.pi-top.com/blog/meetpi-top4diyedition) | 128GB MicroSD (Integral)    | [pi-topOS - Bullseye](https://www.pi-top.com/resources/download-os)                                | pi-top   | Boxed                                                                                                              |
| Raspberry Pi 4 Model B V1.5 | c03115   | BCM2711 | 4GB | [Cluster HAT Case v3.0](https://thepihut.com/products/cluster-hat-case)     | 128GB MicroSD (Integral)    | [Raspberry Pi OS Lite (64-bit) - Bookworm ClusterCTRL](https://github.com/burtyb/clusterhat-image) | cbridge  | Boxed with [Cluster Hat v2.5](https://thepihut.com/products/cluster-hat-v2-0)                                      |
| Raspberry Pi 400 V1.0       | c03130   | BCM2711 | 4GB |                                                                             | 256GB MicroSD (Integral)    | Raspberry Pi OS Lite (64-bit) - Bookworm                                                           | pi400    | Boxed with [DACBerry 400 S](https://www.osaelectronics.com/learn/tutorials/dacberry-400-series-quick-start-guide/) |
