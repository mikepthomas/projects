...
| Item                                                                                                                              | Quantity | Material                                                    | Size | Weight | Cost | Printed | Notes                                                        |
| --------------------------------------------------------------------------------------------------------------------------------- | -------- | ----------------------------------------------------------- | ---- | ------ | ---- | :-----: | ------------------------------------------------------------ |
| ~[Carrier_Dummy](https://github.com/chirpy2605/voron/blob/main/V0/Dragon_Burner/STLs/v0.2/%5Ba%5D_Carrier_Dummy.stl)~             | ~1~      | [LDO ABS (Black)][primary]                                  |      |        |      |   :x:   | Not required, I will be using Fysetc RGB Sequins             |
| ~[Carrier_Neopixel](https://github.com/chirpy2605/voron/blob/main/V0/Dragon_Burner/STLs/v0.2/%5Bo%5D_Carrier_Neopixel.stl)~       | ~1~      | [LDO ABS (Black)][primary]                                  |      |        |      |   :x:   | Not required, I will be using Fysetc RGB Sequins             |
...
| Item                                                                                                                | Quantity | Material                   | Size | Weight | Cost | Printed | Notes                                                         |
| ------------------------------------------------------------------------------------------------------------------- | -------- | -------------------------- | ---- | ------ | ---- | :-----: | ------------------------------------------------------------- |
| ~[ADXL_Mount_Front](https://github.com/chirpy2605/voron/blob/main/V0/Dragon_Burner/STLs/v0.2/ADXL_Mount_Front.stl)~ | ~1~      | [LDO ABS (Black)][primary] |      |        |      |   :x:   | Not required as Picobilical has ADXL sensor on toolhead board |
